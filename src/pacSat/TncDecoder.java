	...
	public void run() {
		...
		try {
			...
			try {
				...
				// This only works with suitable delays!  Check the manual
//				int[] by = {0x00,0xA2,0xA6,0xA8,0x40,0x40,0x40,0x02,0xA0,0x8C,0xA6,0x66,0x40,0x40,0x17,0x03,0xBD,0x20,
...
//						00,0x02,0xCD,0x09,0x0B,0x00,0x02,0x50,0x00,0x00,0x00,0x00,0x51,0x61};
//				sendFrame(by);
				while (running) {
					// wait for close
					// send any commands
	...
	private void sendFrame(int[] bytes) throws SerialPortException {
